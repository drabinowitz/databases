...
describe("Persistent Node Chat Server", function() {
  ...
  it("Should output all messages from the DB", function(done) {
    // Let's insert a message into the db
       var queryString = "INSERT INTO messages (text, created_at, id_users, id_rooms) VALUES ('Men like you can never change!', NOW(), 1, (SELECT id FROM rooms WHERE name = 'main'));";
       // var queryArgs = [];
